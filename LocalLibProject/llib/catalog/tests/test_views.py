...
class AuthorCreateViewTest(TestCase):
    ...
    def test_user_without_perm_cant_access(self):
    ...
    def test_redirect_correctly_on_success(self):
        ...
        response = self.client.post(reverse('author-create'), 
                                    {'first_name':'Johnny', 'last_name':'Marker', 'date_of_birth':'12/04/1995'})
        pk = Author.objects.get(first_name = 'Johnny', last_name = 'Marker').pk
        self.assertRedirects(response, reverse('author-detail', kwargs = {'pk':pk}))